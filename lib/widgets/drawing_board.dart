          ...
          child: Stack(
            ...
            children: [
              if (item is ImageItem)
                SizedBox.expand(child: Image.memory(item.imageBytes, fit: BoxFit.fill))
      ...
      items: [
        ...
        if (item is ImageItem)
          PopupMenuItem(
            ...
            onTap: () {
               // Placeholder: in a real app, this would trigger an overlay
               ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Image Cropping Mode Active')));
            },
          ),
        PopupMenuItem(
          child: const ListTile(
